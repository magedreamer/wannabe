...
class Tools_Swatch_Block_Adminhtml_Widget_Grid_Column_Renderer_Swatch extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    protected function _getValue(Varien_Object $row) {
        ...
        $url = Mage::helper('swatch')->getImageUrl($val);
        $size = Mage::helper('swatch')->getImageThumbSize($val);
        $file_extis = Mage::helper('swatch')->getFileExists($val);
