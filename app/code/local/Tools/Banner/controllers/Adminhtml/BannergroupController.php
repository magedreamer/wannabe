 ...
 */
class Tools_Banner_Adminhtml_BannergroupController extends Mage_Adminhtml_Controller_action {

    protected function _initAction() {
        $this->loadLayout()
                ->_setActiveMenu('tools/banner/bannergroup')
    ...
    public function editAction() {
        ...
        if ($model->getId() || $id == 0) {
            ...
            $this->loadLayout();
            $this->_setActiveMenu('tools/banner/bannergroup');
    ...
    public function saveAction() {
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                $model->save();
                Mage::helper('banner')->cleanCache(Tools_Banner_Block_Banner::GROUP_CACHE_TAG.'_'.$this->getRequest()->getParam('id'));
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('tools/banner/bannergroup');
    }
}