 ...
 */
class Tools_Banner_Adminhtml_BannerController extends Mage_Adminhtml_Controller_action {

    protected function _initAction() {
        $this->loadLayout()
                ->_setActiveMenu('tools/banner/banner')
    ...
    public function editAction() {
        ...
        if ($model->getId() || $id == 0) {
            ...
            $this->loadLayout();
            $this->_setActiveMenu('tools/banner/banner');
    ...
    public function saveAction() {
        ...
        if (!empty($_FILES['filename']['name'])) {
            try {
                ...
                if($_FILES['filename']['size'] > $MAXIMUM_FILESIZE){
                    Mage::getSingleton('adminhtml/session')->addError(Mage::helper('banner')->__('File size only allow 1M'));
        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                $model->save();
                Mage::helper('banner')->cleanCache(Tools_Banner_Block_Banner::CACHE_TAG.'_'.$this->getRequest()->getParam('id'));
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('tools/banner/banner');
    }
}