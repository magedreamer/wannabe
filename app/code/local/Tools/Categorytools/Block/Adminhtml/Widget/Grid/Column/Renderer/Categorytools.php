...
class Tools_Categorytools_Block_Adminhtml_Widget_Grid_Column_Renderer_Categorytools extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    protected function _getValue(Varien_Object $row) {
        ...
        $url = Mage::helper('categorytools')->getImageUrl($val);
        $size = Mage::helper('categorytools')->getImageThumbSize($val);
        $file_extis = Mage::helper('categorytools')->getFileExists($val);
